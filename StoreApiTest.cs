...
public class StoreApiTest
{
    ...
    private const string PET_ID = "22";
    private const string USER_ID = "2";
    ...
    [Test, Order(7), Description("call not existing Path ID")]
    public void Should_Return_NotFound_NonExistingPathID()
    {
        var restClient = new RestClient(BASE_URL);
        var restRequest = new RestRequest("/v2/pet/" + PET_ID, Method.GET);
        restRequest.AddHeader("accept", "application/json");
    ...
    [Test, Order(8), Description("Delete Non Exist Pet id")]
    public void Should_Return_NotFound_ForDeletingPetId()
    {
        var restClient = new RestClient(BASE_URL);
        var restRequest = new RestRequest("/v2/pet/" + PET_ID, Method.DELETE);
        restRequest.AddHeader("accept", "application/json");
        restRequest.RequestFormat = DataFormat.Json;
